...
/**
 * Nesine, Mackolik ve kullanıcı girdisindeki takım adı varyasyonlarını
 * kontrollü biçimde eşleştirir.
 */
export function teamNamesMatch(left, right) {
  ...
  if (isAcronymOf(left, rightTokens) || isAcronymOf(right, leftTokens)) {
    return true;
  }
